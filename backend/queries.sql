...
INSERT INTO genre (name, description) VALUES
    ...
    ('Комедия', 'Жанр комедии предназначен для создания смешных и забавных ситуаций, часто с использованием юмора и иронии.'),
    ('Драма', 'Жанр драмы фокусируется на серьезных и эмоционально насыщенных событиях и персонажах.'),
    ('Боевик', 'Боевики характеризуются интенсивными действиями, боями и преследованиями.'),
    ('Триллер', 'Триллеры создают напряжение и волнение у зрителя, часто с элементами сюжетного поворота и неожиданных событий.'),
    ('Мелодрама', 'Мелодрамы фокусируются на романтических отношениях и эмоциональных переживаниях главных героев.'),
    ('Фэнтези-комедия', 'Комедийные элементы в сочетании с фантастическими мирами и персонажами.'),
    ('Драматический триллер', 'Триллер с акцентом на драматические сюжеты и персонажей.'),
    ('Криминал', 'Жанр криминала описывает преступные события, расследования и судебные процессы.'),
    ('Исторический', 'Исторические фильмы основаны на реальных исторических событиях или периодах.'),
    ('Вестерн', 'Вестерны часто разворачиваются в американском Диком Западе и описывают приключения героев в этом контексте.'),
    ('Научная фантастика', 'Научная фантастика фокусируется на научных концепциях и технологическом прогрессе.'),
    ('Фэнтези-драма', 'Драматические элементы в сочетании с фантастическими мирами и персонажами.');
SELECT * FROM genre;
